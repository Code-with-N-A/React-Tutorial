...
function App(){
 const userName = [
  ...
  return(
    <>
    <h1 id="hed">Loops consept:</h1>
    <table border="1" style={{ borderCollapse: "collapse", width: "100%", margin: "20px auto", textAlign: "left" }}>
        <thead>
            <tr style={{ backgroundColor: "#f2f2f2",textAlign:"center" }}>
            <th style={{ padding: "8px" }}>S.No</th>
            <th style={{ padding: "8px" }}>Name</th>
            <th style={{ padding: "8px" }}>Numver</th>
        ...
        <tbody>
          {userName.map((userName, index)=>(
            <tr key={index}>
              ...
              <td style={{padding: "8px",textAlign: "center"}}>{userName.name.toLocaleUpperCase()}</td>
              <td style={{padding: "8px",textAlign: "center"}}>{userName.number}</td>
              <td style={{padding: "8px",textAlign: "center"}}><a href={userName.email}>{userName.email.toLocaleLowerCase()}</a></td>
