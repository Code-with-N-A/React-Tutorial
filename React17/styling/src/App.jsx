...
function App() {
  const[gred,setGrade]=useState(true)
  ...
  const [btnstyle, setBtnStyle] = useState({
    ...
    cursor: "pointer",
    fontWeight: "bold",
    boxShadow: "0 0 10px rgba(12, 224, 248, 0.27)",
  ...
  const [btnstyle1, setBtnStyle1] = useState({
    ...
    cursor: "pointer",
    fontWeight: "bold",
    boxShadow: "0 0px 4px 10px rgba(230, 236, 247, 0.27)",
  ...
  function grayThme() {
    ...
    setBtnStyle1({
      ...
      border: "none",
      cursor: "pointer",
      boxShadow: "0 0 10px rgba(74, 26, 249, 0.27)",
    });
  }
  ...
  return (
    <>
      <h1>Card Styling in useState</h1>
      <div
        className="bt"
        style={{
      ...
      >
        ...
        <button onClick={grayThme} style={btnstyle}>Gray Theme</button>
        <button onClick={defoltThme} style={btnstyle1}>Default Theme</button>
        <button onClick={()=>setGrade(!gred)}>grad</button>
      </div>
      <div className="man"

        style={{
          display: gred?"flex":"block",
          justifyContent: "center",   // Cards ko center karne ke liye
          alignItems: "center",
          gap: "20px",                // Har card ke beech ka gap
          flexWrap: "wrap",
          margin: "0 auto",
          width: "100%",
        }}
      >
        <div className="contenor" style={cardStyle} >
          <img
            style={imgStyle}
