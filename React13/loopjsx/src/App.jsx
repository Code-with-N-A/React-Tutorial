import "./App.css";
import Office from "./officse";
function App() {
  const userName = [
    { name: "Nitesh Amule", number: "9876543210", email: "amulestack93@gmail.com" },
    ...
    <>
      ...
      >
        <thead style={{ backgroundColor: "#f4f4f4" }}>
          <tr>
            <th style={{ padding: "12px", border: "1px solid #000000ff" }}>S.No</th>
            <th style={{ padding: "12px", border: "1px solid #000000ff" }}>Name</th>
            <th style={{ padding: "12px", border: "1px solid #000000ff" }}>Number</th>
            <th style={{ padding: "12px", border: "1px solid #000000ff" }}>Email</th>
          </tr>
        </thead>
        <tbody>
          {userName.map((user, index) => (
            <Office key={user.email} user={user} index={index} />
          ))}
        </tbody>
